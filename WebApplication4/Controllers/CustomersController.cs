...
namespace WebApplication4.Controllers
{
    ...
    public class CustomersController : ControllerBase
    {
        ...
        public CustomersController(Test1Context context)
        {
            _context = context;
        }
        ...
        public IEnumerable<object> GetCustomer()
        {
            var customers = from  cus in _context.Customer
                            select new
                           {
                               cus.Custid,cus.InitialCode,
                               InitialName = _context.Initial
                               .Where(a=>a.InitialCode==cus.InitialCode)
                               .Select(p => p.InitialName).FirstOrDefault(),
                                cus.CustName,
                                cus.CustLastname,
                                cus.CustType
                            };
